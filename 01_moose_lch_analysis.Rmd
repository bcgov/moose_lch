...
kable (table.pop.data,
       caption = "<b>Table 1. Moose Population Parameter Estimates by Study Area and Year.<b>",
...
Less Than 9 Years Old in the Study Area MCPs",
        x = "Proportion Cutblocks Less Than 9 years Old",
        y = "Adult Female Moose Survival Rate",
...
Pine Beetle Disturbed Stands Less Than 9 Years Old in the Study Area MCPs",
        x = "Proportion Mountain Pine Beetle Disturbed Stands Less Than 9 years Old",
        y = "Adult Female Moose Survival Rate",
       caption = "Note: Black line shows model fitted relationship.") + 
  scale_shape_discrete (name = "Study Area") +
  scale_x_continuous (breaks = seq (0, 0.2, by = 0.02)) +
...
When considering only mortalities from wolves (Fig. 6), the effect of less than 9 year old mountain pine beetle disturbed stands on survival was not statistically significant (*t-value* = 0.12, *p-value* = 0.836), and close to zero. 
...
When considering only mortalities from hunting (Fig. 7), the effect of less than 9 year old mountain pine beetle disturbed stands was not statistically significant (*t-value* = 0.13, *p-value* = 0.905), and close to zero. 
...
Disturbed Stands Less Than 9 Years Old in the Study Area MCPs",
        x = "Proportion Disturbed Stands and Cutblocks Less Than 9 years Old",
        y = "Adult Female Moose Survival Rate",
       caption = "Note: Black line shows model fitted relationship.") + 
  scale_shape_discrete (name = "Study Area") +
...
Mortalities Only, by Proportion of Area of Disturbed Stands Less Than 9 Years Old in the Study Area MCPs",
        x = "Proportion Disturbed Stands Less Than 9 years Old",
        y = "Adult Female Moose Survival Rate (Wolf Mortalities)",
       caption = "Note: Black line shows model fitted relationship.") + 
  scale_shape_discrete (name = "Study Area") +
  scale_x_continuous (breaks = seq (0, 0.2, by = 0.02)) +
...
ggplot (data, aes (x = prop_disturb_all_8_year, 
  ...
  geom_line (aes (x = prop_disturb_all_8_year, 
                   y = predict (lme.fit, newdata = data, level = 0))) +
  labs (title = "Figure 10. Adult Female Moose Survival Rate, When Considering Hunting 
