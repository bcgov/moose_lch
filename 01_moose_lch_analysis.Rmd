...
## Introduction
Here I summarize data to explore the moose 'landscape change hypothesis' (LCH). The moose LCH posits that recent moose population declines in parts of central British Columbia were related to large-scale changes to forest cover (i.e., landscape disturbance), caused by an extensive mountain pine beetle (MBP) infestation and subsequent forest harvest to salvage MPB killed forest stands. As a preliminary test of the LCH, I relate estimates of forest disturbance from MPB and forestry (cutblocks) to estimates of adult female moose survival and cow/calf moose ratios measured in five study areas. 

The LCH predicts a negative correlative relationship between the amount of landscape disturbance and adult female survival or the ratio of calves to cow moose. This relationship is indicative that processes related to landscape disturbance, i.e., reduced amount of security and thermal cover and increased amount of neagtive interactions with humans due to higher road densities are causing moose population declines. 

## Methods

### Study Areas
The LCH was tested by sampling moose survival rates in the Big Creek, Bonaparte, Entiako, John Prince Research Forest and Prince George South study areas. The five study areas were selected because they had varied levels of MPB and forestry related disturbance. A sample of moose in each study area were captured and collared with global positioning system (GPS) telemetry collars. Annual moose study area boundaries were determined by calculating the 100% minimum convex polygon MCP of annual sampled adult female moose GPS locations in each area. Moose locations were collected for four years from 2015 to 2018 (except Entiako, where data was collected for 5 years, form 2014 to 2018), and thus study areas were re-calcualted for each of these years.  

### Popualtion Data 
ADult female moose survival rates were estimated from data on survival by these sampled animals. In addition, aerial cow/calf composition surveys were completed annually in each study area. 
...
- tables iwht lelevsl of disturbance
...
#### Cutblocks
- relationship between cutblocks and survival or recruitment 
...
ggplot (data, aes (x = (cut_15_year_area_ha*0.01), 
  ...
  geom_smooth (method = lm) +
  facet_grid (.~name_sa, scales = "free") +
  labs (title = "Adult Female Moose Survival Rate by Total Area of Cutblocks <15 years old in 
the Study Area MCPs",
...
- if we look over a 15 year period.... the opposite efefct of what is exepcted
...
ggplot (data, aes (x = (delta_prop_cut_15_year_area_ha*100), 
  ...
  facet_grid (.~name_sa, scales = "free") +
  labs (title = "Change in Adult Female Moose Survival Rate by Change in Percent of Area that 
is Cutblocks <15 years old in the Study Area MCPs",
        x = "Change in Percent of Area that is Cutblocks <15 years old",
        y = "Change in Adult Female Moose Survival Rate") +
  theme (axis.text.x = element_text (angle = 45))
```

-  nothing clear with adult females, what about calves?
  - over 8 year period, mostly flat slopes, not much here....
...
ggplot (data, aes (x = (cut_8_year_area_ha*0.01), 
  ...
  geom_smooth (method = lm) +
  facet_grid (.~name_sa, scales = "free") +
  labs (title = "Moose Calf/100 Cows Ratio by Total Area of Cutblocks <8 years old in 
the Study Area MCPs",
        x = "Total Area of Cutblocks <8 years old (km2)",
        y = "Calves/100 Cows") 
```
...
- over 15 years
  - declines in Big Creek, Entiako, and PG South, but increase in Bonaparte and JPRF
...
ggplot (data, aes (x = (cut_15_year_area_ha*0.01), 
  ...
  geom_smooth (method = lm) +
  facet_grid (.~name_sa, scales = "free") +
  labs (title = "Moose Calf/100 Cows Ratio by Total Area of Cutblocks <15 years old in 
the Study Area MCPs",
        x = "Total Area of Cutblocks <15 years old (km2)",
        y = "Calves/100 Cows") 
```
...
- if we consider rate of change
 - no clear pattern across tudy areas
...
- over a 15 year period 
  - no clear pattern again, but if anything, more calves in higher rates of distruabnce
...
- in general, no clear relationship between amount and rate of forestry disturbance and survival rate or recruitment rate
- so, maybe this is an MPB effect

#### MPB

- if not cublocks, then maybe mountain pine beetle disturbance has an effect
- grouped moderate, severe and very severely disturbed stands together
